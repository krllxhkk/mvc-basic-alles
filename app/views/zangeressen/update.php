        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/ZangeressenController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="leeftijd" type="number" min="0" class="form-control <?= isset($data['errors']['leeftijd']) ? 'is-invalid' : ''; ?>" id="leeftijd" value="<?= $_POST['leeftijd'] ?? $data['zangeres']->Leeftijd; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="aantalhits" type="number" min="0" class="form-control <?= isset($data['errors']['aantalhits']) ? 'is-invalid' : ''; ?>" id="aantalhits" value="<?= $_POST['aantalhits'] ?? $data['zangeres']->AantalHits; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="debuutjaar" type="number" min="1900" max="2100" class="form-control <?= isset($data['errors']['debuutjaar']) ? 'is-invalid' : ''; ?>" id="debuutjaar" value="<?= $_POST['debuutjaar'] ?? $data['zangeres']->DebuutJaar; ?>">
                ...
                <div class="mb-3">
                    ...
                    <select name="isactief" class="form-control <?= isset($data['errors']['isactief']) ? 'is-invalid' : ''; ?>" id="isactief">
                        ...
                        <option value="1" <?= (($_POST['isactief'] ?? $data['zangeres']->IsActief) == 1) ? 'selected' : ''; ?>>Ja</option>
                        <option value="0" <?= (($_POST['isactief'] ?? $data['zangeres']->IsActief) == 0) ? 'selected' : ''; ?>>Nee</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input name="opmerking" type="text" class="form-control <?= isset($data['errors']['opmerking']) ? 'is-invalid' : ''; ?>" id="opmerking" value="<?= $_POST['opmerking'] ?? $data['zangeres']->Opmerking; ?>">
